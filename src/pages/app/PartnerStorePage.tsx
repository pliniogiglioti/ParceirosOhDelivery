  ...
  return (
    <SectionFrame eyebrow="Loja" title="Edicao simulada do estabelecimento">
      <div className="space-y-6">
        ...
        {activeTab === 'pedidos' ? <StoreOrdersTab /> : null}
      </div>
    </SectionFrame>
  )
}
